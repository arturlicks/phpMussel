...
$phpMussel['lang']['config_signatures_detect_adware'] = 'Moet phpMussel verwerken handtekeningen voor het detecteren van adware? False = Nee; True = Ja [Standaard].';
$phpMussel['lang']['config_signatures_detect_deface'] = 'Moet phpMussel verwerken handtekeningen voor het detecteren van schendingen/defacements en schenders/defacers? False = Nee; True = Ja [Standaard].';
$phpMussel['lang']['config_signatures_detect_joke_hoax'] = 'Moet phpMussel verwerken handtekeningen voor het detecteren van grap/beetnemerij malware/virussen? False = Nee; True = Ja [Standaard].';
$phpMussel['lang']['config_signatures_detect_packer_packed'] = 'Moet phpMussel verwerken handtekeningen voor het detecteren van verpakkers en verpakt gegevens? False = Nee; True = Ja [Standaard].';
$phpMussel['lang']['config_signatures_detect_pua_pup'] = 'Moet phpMussel verwerken handtekeningen voor het detecteren van PUAs/PUPs? False = Nee; True = Ja [Standaard].';
$phpMussel['lang']['config_signatures_detect_shell'] = 'Moet phpMussel verwerken handtekeningen voor het detecteren van shell scripts? False = Nee; True = Ja [Standaard].';
...
$phpMussel['lang']['config_signatures_MD5'] = 'Gebruik MD5 handtekeningen bij het scannen? Als dat zo is, geef de namen van de handtekening bestanden te gebruiken, gescheiden door komma\'s.';
$phpMussel['lang']['config_signatures_PE_Extended'] = 'Gebruik PE uitgebreide handtekeningen voor de PE-bestanden (EXE, DLL, e.z.v.) bij het scannen? Als dat zo is, geef de namen van de handtekening bestanden te gebruiken, gescheiden door komma\'s.';
$phpMussel['lang']['config_signatures_PE_Sectional'] = 'Gebruik PE Sectionele handtekeningen voor de PE-bestanden (EXE, DLL, e.z.v.) bij het scannen? Als dat zo is, geef de namen van de handtekening bestanden te gebruiken, gescheiden door komma\'s.';
