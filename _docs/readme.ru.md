...
/vault/signatures/mail_clamav_regex.cvd | Почты сигнатуры файлов.
/vault/signatures/mail_clamav_regex.map | Почты сигнатуры файлов.
/vault/signatures/mail_clamav_standard.cvd | Почты сигнатуры файлов.
/vault/signatures/mail_clamav_standard.map | Почты сигнатуры файлов.
/vault/signatures/mail_mussel_regex.cvd | Почты сигнатуры файлов.
/vault/signatures/mail_mussel_standard.cvd | Почты сигнатуры файлов.
/vault/signatures/clamav.hdb | Файл с MD5 подписями.
/vault/signatures/phpmussel.hdb | Файл с MD5 подписями.
...
/vault/signatures/phpmussel.pex | Файл с PE расширенного опознавания подписями.
/vault/signatures/clamav.mdb | Файл с PE-секционных подписями.
/vault/signatures/phpmussel.mdb | Файл с PE-секционных подписями.
...
Последнее обновление: 19 Декабрь 2016 (2016.12.19).
